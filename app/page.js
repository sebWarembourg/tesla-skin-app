...
export default function TeslaSkinGenerator() {
  ...
  const processImage = useCallback((sourceImg, opts) => {
    ...
    setTimeout(() => {
      ...
      // Draw source texture with rotation + crop (zoom + pan)
      ctx.save();
      ...
      // Apply mask: white pixels = texture, rest = black
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-[#0f0f1a] to-black flex flex-col items-center px-4 py-10">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-zinc-500 text-sm mt-3 max-w-sm">
          Dépose une image ou texture — elle sera automatiquement appliquée sur le gabarit Tesla.
        </p>
      </div>
